[CRITICAL RULE]: ONLY apply these React and Tailwind rules if the file path contains "/currify-front/". If the file is in another directory, IGNORE THIS SKILL COMPLETELY.
# (Resto del contenido original del archivo...)
