...
---
[CRITICAL RULE]: ONLY apply these rules if the file path contains "/currify-front/".
IMPORTANT: This project is a pure React SPA (Vite/CRA), NOT Next.js. Ignore any instructions related to Server Components, App Router, or the "use client" directive. Focus strictly on the Radix UI, Tailwind CSS, and Zod integration patterns.
