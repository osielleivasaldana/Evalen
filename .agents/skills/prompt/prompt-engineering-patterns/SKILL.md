...
- Designing evaluation rubrics and grading criteria
- Structuring output formats for consistent validation (scores, rationales, violations)
- Pairwise comparison and absolute grading patterns
- Identifying and mitigating biases (length bias, position bias)
- Continuous evaluation loops and benchmark datasets
...
Detailed pattern documentation lives in `references/details.md` and the `references/llm-as-a-judge.md` guide. Read those files when the navigation tier above is insufficient.
