...
metadata:
  ...
  version: "7.0.0"
---
[CRITICAL RULE]: ONLY apply these Prisma and database rules if the file path contains "/currify-back/". If the file is in another directory, IGNORE THIS SKILL COMPLETELY.
