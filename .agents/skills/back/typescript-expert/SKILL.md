...
---
[CRITICAL RULE]: ONLY apply these strict TypeScript rules if the file path contains "/currify-back/". If the file is in another directory, IGNORE THIS SKILL COMPLETELY.
# TypeScript Expert
