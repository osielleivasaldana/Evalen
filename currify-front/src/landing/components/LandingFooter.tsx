        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="/home#features" className="text-gray-300 hover:text-white transition-colors">
                  Beneficios
                </a>
              </li>
              <li>
                <a href="/home#pricing" className="text-gray-300 hover:text-white transition-colors">
                  Precios
                </a>
              </li>
              <li>
